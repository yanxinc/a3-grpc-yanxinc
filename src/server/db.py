...
posts = {
    ...
    2: reddit_pb2.Post(title="post3333", text="asdjfhasljkfhsd", image_url="image2.img", author=users[2], score=333, state=reddit_pb2.Post.NORMAL, publication_date="2023-12-10 12:12:12", subreddit_id=0, tags=["new", "public", "popular"])
}
...
subreddits = {
    0: reddit_pb2.Subreddit(id=0, name="SR1", state=reddit_pb2.Subreddit.SubredditState.PUBLIC, tags=["new", "public", "popular"])
}